			...
			<Space direction='vertical' size={96} style={{ width: '100%' }}>
				<section
					style={{
						...
						overflow: 'hidden',
						background:
							'radial-gradient(circle at top right, rgba(99, 102, 241, 0.35), transparent 55%), #0f172a'
					}}
				>
					<div
						style={{
							...
							<Col xs={24} lg={14}>
								...
								>
									...
									>
										<Title
											level={1}
											style={{ color: '#f8fafc', marginBottom: 0 }}
										>
											Подготовься к собеседованию в IT быстрее, чем
											потратят вопрос
										</Title>
										<Paragraph
											style={{
										...
										>
											easyOffer собирает реальные вопросы из
											интервью, считает их частотность и подсказывает
											краткие ответы. Ты видишь, что действительно
											спрашивают компании, и готовишься точечно.
										</Paragraph>
									</Space>
									...
									>
										<Space direction='vertical' size={8}>
											<Text style={{ color: '#e0e7ff' }}>
												Не теряешь время на поиск формулировок
											</Text>
											<Text
												type='secondary'
												style={{ color: '#cbd5f5' }}
											>
												easyOffer обновляет базу каждую неделю и
												показывает свежие вопросы, которые звучали у
												кандидатов.
											</Text>
										</Space>
									</Card>
					...
					>
						...
						>
							...
							>
								...
								<Paragraph
									style={{ margin: 0, color: '#475569', fontSize: 18 }}
								>
									От выбора роли до закрепления знаний — все шаги
					...
					>
						<Row gutter={[32, 32]} align='middle'>
							<Col xs={24} lg={10}>
								...
								>
									<Title level={2} style={{ margin: 0 }}>
										Внутри уже собрано всё, чтобы приходить на
										интервью подготовленным
									</Title>
									<Paragraph
										style={{
											color: '#475569',
									...
									>
										Сразу видишь частотность, шанс услышать вопрос,
										follow-up сценарии и материалы для повторения.
										Никаких табличек и нескончаемых вкладок — только
										актуальные данные.
									</Paragraph>
						...
						>
							...
							>
								...
								<Paragraph
									style={{ margin: 0, color: '#475569', fontSize: 18 }}
								>
									Начни с демо и переходи на Pro, когда понадобится
									полный доступ.
								</Paragraph>
							</Space>
							<Row gutter={[24, 24]}>
								<Col xs={24} md={12}>
									...
									>
										<Space direction='vertical' size={8}>
											...
											<Text type='secondary'>
												Открой структуру ролей и первые 50 вопросов
												на каждую.
											</Text>
										</Space>
										<List
									...
									>
										<Space direction='vertical' size={8}>
											...
											<Text
												...
												style={{ color: '#e0e7ff' }}
											>
												Сохраняй любимые вопросы, смотри тренды
												компаний и получай свежие подборки каждую
												неделю.
											</Text>
										</Space>
										<List
					...
					>
						...
						>
							...
							>
								...
								<Paragraph
									style={{ margin: 0, color: '#cbd5f5', fontSize: 18 }}
								>
									Открой демо сегодня, а когда будешь готов — переходи
									на Pro и получай свежие подборки каждую неделю.
								</Paragraph>
							</Space>
							<Divider
