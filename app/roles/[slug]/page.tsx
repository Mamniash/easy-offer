			...
			>
				<Space direction='vertical' size={24} style={{ width: '100%' }}>
					...
					>
						...
						<Text type='secondary'>
							Free-лимит: {limit - remaining}/{limit} использовано ·
							Осталось {remaining}
						</Text>
					</Card>
										...
										<Col xs={24} md={8}>
											...
											>
												...
												<Select
													value={stage}
													onChange={(value) =>
														setStage(value as typeof stage)
													}
								...
								<Row gutter={[24, 24]}>
									<Col xs={24} lg={16}>
										...
										>
											<Space direction='vertical' size={8}>
												...
												<Text type='secondary'>
													Открываем первые 50 карточек, чтобы ты
													увидел структуру и формат ответов.
												</Text>
											</Space>
											{isLoading ? (
												<Space
												...
												>
													<Space direction='vertical' size={12}>
														<Text strong>
															По таким фильтрам ничего не нашли.
														</Text>
														<Button
															onClick={() => {
																setLevel('all')
												...
												>
													{visible.map((question, index) => {
														const palette =
															companyPalette[
																index % companyPalette.length
															]
														const videoCount =
															question.answerVariants.filter(
																(variant) =>
																	variant.source === 'youtube'
															).length
														const totalMentions =
															question.weeklyMentions.reduce(
																(acc, value) => acc + value,
																0
															)
														...
														return (
															...
															>
																...
																>
																	...
																	>
																		<Tooltip
																			title={`Частота ${formatPercent(question.frequencyScore)}`}
																		>
																			<div
																				style={{
																					width: 14,
													...
													<Row gutter={[24, 24]} align='middle'>
														<Col xs={24} md={16}>
															...
															>
																...
																>
																	Доступно {visible.length}{' '}
																	вопросов из {filtered.length}
																</Title>
																<Text
																	type='secondary'
																	style={{ color: '#4338ca' }}
																>
																	Оформи Pro, чтобы раскрыть
																	весь каталог, получить задачи
																	и сохранить любимые карточки.
																</Text>
																<List
									...
									<Col xs={24} lg={8}>
										...
										>
											...
											<Text type='secondary'>
												Смотрим, какие бренды чаще упоминают такие
												вопросы на интервью.
											</Text>
											<Space direction='vertical' size={12}>
											...
											>
												<Text
													...
													style={{ fontSize: 12 }}
												>
													В подписке появятся фильтры по брендам,
													графики трендов и подборки вопросов по
